...
public class studentReportAdapter extends RecyclerView.Adapter<studentReportAdapter.Holder> {
    ...
    public studentReportAdapter(Context context, ArrayList<Model_TM> arrayList) {
